...
namespace Garuda.Utilities.Events;
...
{
    public static IEnumerable<TEventHandler> Broadcast(TEventArgument1 argument1,
                                                       TEventArgument2 argument2,
                                                       TEventArgument3 argument3)
    {
        IEnumerable<TEventHandler> eventHandlers = ExtensionManager.GetInstances<TEventHandler>()
                                                                   .OrderBy(eh => eh.Priority)
                                                                   .ToList();
