...
namespace Garuda.Migrations
{
    ...
    [Migration("20240816040206_TransactionSeeder")]
    partial class TransactionSeeder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Garuda.Domain.Common.Models.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8b7e3e2f-b32a-4c8e-a3f5-4e7e848ea704"),
                            Amount = 1500.00m,
                            AnimalId = new Guid("f6268f99-c46f-498e-b2ec-676ce7a7541e"),
                            BuyerId = new Guid("c3e20f8e-92a7-4c19-90a2-7fb66fd1b6b1"),
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 8, 16, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SellerId = new Guid("f7a74c57-8968-4b3a-91e5-38b2f6aef91c"),
                            Status = "Completed",
                            TransactionDate = new DateTime(2024, 8, 16, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
